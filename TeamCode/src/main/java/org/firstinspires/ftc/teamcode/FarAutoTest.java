...
@Config
public class FarAutoTest extends LinearOpMode {

    boolean isRed = false;
    @Autonomous()
    public static class RedFarAutoTest extends FarAutoTest {
        public RedFarAutoTest() {
    ...
    @Autonomous()
    public static class BlueFarAutoTest extends FarAutoTest {
        public BlueFarAutoTest() {
            super(
    ...
    public FarAutoTest(Pose2d startingPose, PoseMap poseMap) {
...
//                        .strafeToLinearHeading(new Vector2d(60, 34), Math.toRadians(-280))
                        .splineToSplineHeading(new Pose2d(60, 34,Math.toRadians(-280)), Math.toRadians(270))
//                        .lineToX(72 /*, new TranslationalVelConstraint(21), null */)
                        .strafeToLinearHeading(new Vector2d(60,67),-280)
