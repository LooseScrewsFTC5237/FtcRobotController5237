...
@Config
public class RedFarAutoSimple extends LinearOpMode {

    boolean isRed = false;
    @Autonomous()
    public static class RedFarSimple extends RedFarAutoSimple {
        public RedFarSimple() {
    ...
    @Autonomous()
    @Disabled
    public static class BlueFarAuto extends RedFarAutoSimple {
        public BlueFarAuto() {
            super(
    ...
    public RedFarAutoSimple(Pose2d startingPose, PoseMap poseMap) {
